            ...
            {query.isSuccess && 
                <>
                    <div className='w-full lg:w-[50%] h-[20rem] lg:h-[30rem]'>
                        <img className="object-cover h-full w-full rounded-xl" alt={'review-img'} src={`http://localhost:5000${query.data.data.attributes.articleImage.data.attributes.url}`} />
                    </div>
