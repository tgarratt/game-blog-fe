        ...
        <div className='flex mt-8 mx-auto' style={{maxWidth: '2000px'}}>
            ...
            {query.isSuccess && 
                <div className='flex w-full'>
                  <div className='hidden md:block text strong-text min-w-[8rem]' style={{minWidth: '15%'}}>
                  ...
                  <div>
                    <div className='text mr-0 md:mr-[25%] ml-0 md:ml-[7.5%] rich-text'>
                        <ReactMarkdown>
                    ...
                    <div className='text mb-12 mr-0 md:mr-[25%] ml-0 md:ml-[7.5%] rich-text'>
                        <ReactMarkdown>
